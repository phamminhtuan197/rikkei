...
import com.rikkei.dto.ReportInventory;
...
//	Page<Product> findAllByCategory(Pageable page);
	...
	@Query("select new com.rikkei.dto.ReportInventory(o.category, sum(o.unitPrice), sum(o.quantity)) from Product o group by o.category order by sum(o.quantity) desc")
