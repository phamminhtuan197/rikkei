package com.rikkei.controller.admin;
...
public class OrderController {
	...
	public ModelAndView cancel(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn đã bị huỷ 1 đơn hàng từ Team2 Shop!",
	...
	public ModelAndView confirm(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở Team2 Shop đã được xác nhận!",
	...
	public ModelAndView delivered(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở Team2 Shop đã thanh toán thành công!",
				"Chúng tôi cám ơn bạn vì đã ủng hộ Team2 Shop!", "Thông báo thanh toán thành công!");
