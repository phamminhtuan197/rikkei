...
//	List<User> findByStatusTrueAndRoleFalse();
	...
	//get admin
	@Query(value = "select * from users where status = 1 and role = 'Admin'", nativeQuery = true)
	List<User> findAllAdmin();
	//getUser
	@Query(value = "select * from users where status = 1 and role = 'User'", nativeQuery = true)
